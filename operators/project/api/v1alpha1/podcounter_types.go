...
// PodCounterSpec defines the desired state of PodCounter
type PodCounterSpec struct {
	Namespace string `json:"namespace"`
}

// PodCounterStatus defines the observed state of PodCounter
...
// PodCounterList contains a list of PodCounter

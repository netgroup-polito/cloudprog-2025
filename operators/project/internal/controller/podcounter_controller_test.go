...
var _ = Describe("PodCounter Controller", func() {
	Context("When reconciling a resource", func() {
		...
		BeforeEach(func() {
			By("creating the custom resource for the Kind PodCounter")
			err := k8sClient.Get(ctx, typeNamespacedName, podcounter)
		...
		AfterEach(func() {
			...
			By("Cleanup the specific resource instance PodCounter")
